...
const DegenAVS_COFHE_1 = require("../DegenAVS_COFHE");
describe("matchBiddersFromInfos unit tests", () => {
    test("basic allocation prefers higher rushFactor", () => {
        ...
        const res = (0, DegenAVS_COFHE_1.matchBiddersFromInfos)(infos, BigInt(600));
    ...
    test("respects per-epoch cap and ordering", () => {
        ...
        const res = (0, DegenAVS_COFHE_1.matchBiddersFromInfos)(infos, BigInt(250));
